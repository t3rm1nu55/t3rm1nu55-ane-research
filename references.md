...
| [asahilinux/m1n1](https://github.com/AsahiLinux/m1n1) | Asahi Linux bootloader with extensive M-series hardware register documentation | 2026-07-19 | Asahi folks have the deepest public understanding of M-series hardware registers. |
| [vladkens/macmon](https://github.com/vladkens/macmon) | Rust macOS monitor using IOReport | 2026-07-19 | Upstream we vendor the IOReport access pattern from. Watch for channel additions. |
...
| [maderix — Inside the M4 Apple Neural Engine (2024)](https://maderix.substack.com/p/inside-the-m4-apple-neural-engine-615) | M4 ANE benchmarking, power, and direct access via `_ANEClient` | 2026-07-19 | Any follow-up from maderix on ANE or successor chips. |
...
| [Bryngelson — ANE Architecture, Programming, and Performance (arXiv 2606.22283)](https://arxiv.org/abs/2606.22283) | Full reverse-engineered ANE architecture: datapath, driver ABI, firmware, command protocol | 2026-07-19 | Driver-level documentation that may identify the register/mailbox interface where ANE utilization metrics live. |
| [Bryngelson — ANEForge: Python for direct ANE computation (arXiv 2606.17090)](https://arxiv.org/abs/2606.17090) | MIT-licensed Python package dispatching directly to ANE daemon/driver, bypassing CoreML | 2026-07-19 | First open-source tool at the ANE driver ABI level; source is a reference for instrumenting ANE dispatch. |
| [Bhan — Above the Inner Loop: LLM Prefill GEMM on M1 AMX (arXiv 2606.25426)](https://arxiv.org/abs/2606.25426) | Reverse-engineers AMX on M1–M3 for LLM prefill GEMM, beating Accelerate | 2026-07-19 | Most detailed public AMX microarchitectural characterization since MIT CSAIL thesis; watch for any kperf event IDs disclosed in supplemental material. |
| [Alpay & Başaran — Residual GPU Cache State on Apple M4 Pro (arXiv 2606.27098)](https://arxiv.org/abs/2606.27098) | Uses kperf/kpc PMU counters (root) and IOReport DCS-agent histograms on M4 Pro | 2026-07-19 | Confirms kperf root-access pattern on M4 Pro; PMU counter IDs in paper are an M4 Pro counter dataset to extract. |
